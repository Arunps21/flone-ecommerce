      ...
      <div className="container px-5 py-10 mx-auto">
        <div className="flex flex-col text-center w-full mb-14">
          ...
          <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
            Our journey from an idea to a thriving platform is driven by
            innovation and user trust. Explore the milestones we've achieved and
            how we continue to grow, engage, and deliver value to our audience
            worldwide.
          </p>
        </div>
            ...
            <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
              <div className="flex flex-col justify-center items-center gap-7">
                ...
                <div className="flex flex-col justify-center items-center">
                  <p className="text-3xl font-semibold leading-none">2.7K</p>
              ...
              <div className="flex flex-col justify-center items-center gap-7">
                ...
                <div className="flex flex-col justify-center items-center">
                  <div className="flex flex-col justify-center align-middle">
                    <p className="text-3xl font-semibold leading-none">1.3K</p>
